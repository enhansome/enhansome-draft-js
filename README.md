...
* [React-Draft-Wyiswyg](https://github.com/jpuri/react-draft-wysiwyg) ⭐ 6,464 | 🐛 752 | 🌐 JavaScript | 📅 2024-12-01 - A WYISWYG editor, with various text editing options and corresponding HTML generation.
* [Braft](https://github.com/margox/braft-editor) ⭐ 4,588 | 🐛 409 | 🌐 JavaScript | 📅 2024-11-19 - Extensible Draft JS Editor
...
* [Z-Editor](https://github.com/Z-Editor/Z-Editor) ⭐ 156 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-12 - Online Z-notations editor.
* [Draft.js Editor](https://github.com/AlastairTaft/draft-js-editor/) ⚠️ Archived - A Rich text editor inspired by Medium & Facebook Notes.
...
* [Draft.js Plugins](https://github.com/draft-js-plugins/draft-js-plugins) ⚠️ Archived - A Plugin architecture on top of Draft.js
  ...
  * [RichButtons](https://github.com/jasonphillips/draft-js-richbuttons-plugin) ⭐ 38 | 🐛 6 | 🌐 JavaScript | 📅 2021-09-17 - Add and customize rich formatting buttons.
  * [Katex](https://github.com/letranloc/draft-js-katex-plugin) ⭐ 32 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-05 - Insert and render LaTeX using Katex.
  * [List](https://github.com/samuelmeuli/draft-js-list-plugin) ⭐ 13 | 🐛 3 | 🌐 TypeScript | 📅 2020-07-18 - Automatic list creation, nested lists
  * [Mathjax](https://github.com/tarjei/draft-js-mathjax-plugin) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2017-05-09 - Edit math using (La)TeX rendered by Mathjax.
  * [Divider](https://github.com/simsim0709/draft-js-plugins/tree/master/draft-js-divider-plugin) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2018-01-18
...
* [Draft.js Gutter](https://github.com/seejamescode/draft-js-gutter) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2016-02-28 - Compliments line number gutter.
* [Draft.js Annotatable](https://github.com/cltk/annotations) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2018-12-13 - Out of the box annotation system for Draft.js with support for user-created annotations.
...
* [Draft.js exporter (Python)](https://github.com/springload/draftjs_exporter) ⭐ 84 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Library to convert Draft.js raw ContentState to HTML
...
* [Draft.js Exporter](https://github.com/rkpasia/draft-js-exporter) ⭐ 34 | 🐛 1 | 🌐 JavaScript | 📅 2016-11-21 - Export and format the content from Draft.js.
* [Draft.js Multidecorators](https://github.com/SamyPesse/draft-js-multidecorators) ⭐ 32 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-16 - Combine multiple decorators.
* [Draft.js SimpleDecorator](https://github.com/Soreine/draft-js-simpledecorator) ⭐ 25 | 🐛 1 | 🌐 JavaScript | 📅 2017-02-13 - Easily create flexible decorators.
* [Draft.js Exporter (Go)](https://github.com/ejilay/draftjs) ⭐ 23 | 🐛 11 | 🌐 Go | 📅 2022-06-08 - Export Draft.js content state into HTML.
* [Draft.js exporter (Ruby)](https://github.com/ignitionworks/draftjs_exporter) ⭐ 16 | 🐛 2 | 🌐 Ruby | 📅 2019-04-11 - Export Draft.js content state into HTML.
* [Draft.js AST Importer](https://github.com/icelab/draft-js-ast-importer) ⭐ 13 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-04- Import an abstract syntax tree (AST) output from the companion draft-js-ast-exporter.
* [Draft.js: Export ContentState to PDFMake](https://github.com/datagenno/draft-js-export-pdfmake) ⭐ 12 | 🐛 6 | 🌐 JavaScript | 📅 2020-08-04 - Export ContentState to PDFMake.
* [Sticky](https://github.com/nadunindunil/sticky) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2018-06-19 - A simple note taking and clipboard managing desktop application
...
* [Draft-js Samples - An app with examples and code explanations](https://github.com/Mair/react-meetup-draftjs) ⭐ 67 | 🐛 3 | 🌐 TypeScript | 📅 2017-09-12
* [Draft drag and drop demo for mobile browser](https://github.com/jan4984/draft-dnd-example) ⭐ 15 | 🐛 0 | 📅 2018-01-26
